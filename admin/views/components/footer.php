<div class="acs-footer">
    <div class="acs-footer-links">
        <ul>
            <li><a href="https://panel.arvancloud.ir/video/vod/" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e( 'Arvan Video Panel', 'arvancloud-vod' ) ?> <span class="dashicons dashicons-external"></span></a></li>
            <li><a href="https://forum.arvancloud.ir/c/vod/41" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e( 'Support', 'arvancloud-vod' ) ?> <span class="dashicons dashicons-external"></span></a></li>
            <li><a href="mailto:support@arvancloud.ir" target="_blank" rel="noopener noreferrer"><?php echo esc_html_e( 'Email Us', 'arvancloud-vod' ) ?> <span class="dashicons dashicons-email"></span></a></li>
        </ul>
    </div>
